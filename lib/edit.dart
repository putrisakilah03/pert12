...
class _EditState extends State<Edit> {
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ...
          " http://169.254.221.36//note_app/detail.php?id='${widget.id}'"));
  ...
  Future _onUpdate(context) async {
    try {
      return await http.post(
        Uri.parse("http://169.254.221.36//note_app/update.php"),
        body: {
          "id": widget.id,
          "title": title.text,
  ...
  Future _onDelete(context) async {
    try {
      return await http.post(
        Uri.parse("http://169.254.221.36//note_app/delete.php"),
        body: {
          "id": widget.id,
        },
      ).then((value) {
